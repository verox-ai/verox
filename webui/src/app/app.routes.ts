...
export const routes: Routes = [
  ...
  { path: 'setup', loadComponent: () => import('./pages/setup/setup.component').then(m => m.SetupComponent) },
  {
    ...
    children: [
      ...
      { path: 'settings/email',   loadComponent: () => import('./pages/settings/email/email.component').then(m => m.EmailComponent) },
      { path: 'settings/usage',   loadComponent: () => import('./pages/settings/usage/usage.component').then(m => m.UsageComponent) },
      { path: 'settings/debug',   loadComponent: () => import('./pages/settings/debug/debug.component').then(m => m.DebugComponent) },
      { path: '**', redirectTo: '' },
    ],
  },
  { path: '**', redirectTo: '' },
